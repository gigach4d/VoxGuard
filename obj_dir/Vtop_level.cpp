...
Vtop_level::Vtop_level(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , push_to_talk{vlSymsp->TOP.push_to_talk}
    , adc_data_valid{vlSymsp->TOP.adc_data_valid}
    , dac_data_valid{vlSymsp->TOP.dac_data_valid}
    , spi_sclk{vlSymsp->TOP.spi_sclk}
    , spi_mosi{vlSymsp->TOP.spi_mosi}
    , spi_miso{vlSymsp->TOP.spi_miso}
    , spi_cs{vlSymsp->TOP.spi_cs}
    , radio_rx_valid{vlSymsp->TOP.radio_rx_valid}
    , adc_data_in{vlSymsp->TOP.adc_data_in}
    , dac_data_out{vlSymsp->TOP.dac_data_out}
    , radio_rx_data{vlSymsp->TOP.radio_rx_data}
    , encrypted_data_out{vlSymsp->TOP.encrypted_data_out}
    , rootp{&(vlSymsp->TOP)}
{
